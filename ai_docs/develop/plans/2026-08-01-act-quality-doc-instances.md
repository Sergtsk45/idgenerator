...
**Создан:** 2026-08-01  
**Обновлён:** 2026-08-01  
**Статус:** 🟡 Частично согласовано (D′ + п.3 перечень + unique + дедуп + выбор в графике и акте); ждут Q6–Q7  
**Приоритет:** Высокий  
...
- **Зависимости**: ответы Q6–Q7 (Q1–Q5 закрыты)
...
- **Шаги**:
  ...
  - [ ] `ActDetail`: редактор приложений — добавить/убрать/порядок docs из реестра/материалов акта; дедуп; бейдж «нет файла»
  - [ ] `ActDetail`: отображение материалов п.3 с учётом multi-row; при ручном изменении materials — политика согласовать в ADR (минимум: apps editable)
...
7. Регресс: однодокументные материалы (как кран LD) работают как раньше.
8. Экспорт приложений атомарный; missing PDF — явная 422 по documentId.
