...
export const translations = {
  en: {
    ...
    selectTaskMaterials: {
      ...
      selectExistingMaterial: 'Select existing material',
      ...
      saved: 'Changes saved',
      createdAndAdded: 'Material created and added to the task',
      createdButNotLinked: 'Material created, but could not be added to the task. It is available in the object materials list.',
      objectNotReady: 'Object is not loaded yet. Wait and try again.',
      taskMissing: 'Task is not selected. Return to the schedule and open materials again.',
    },
    sourceData: {
      title: 'Source data',
      sections: {
  ...
  ru: {
    ...
    selectTaskMaterials: {
      ...
      createNewMaterial: 'Создать новый материал',
      selectExistingMaterial: 'Выбрать существующий материал',
      ...
      createdAndAdded: 'Материал создан и добавлен в задачу',
      createdButNotLinked: 'Материал создан, но не удалось добавить его в задачу. Он доступен в материалах текущего объекта.',
      objectNotReady: 'Объект ещё не загружен. Подождите и попробуйте снова.',
      taskMissing: 'Задача не выбрана. Вернитесь к графику и откройте материалы снова.',
    },
    sourceData: {
      ...
      persons: {
        ...
        copy_certifier: 'Заверитель копий',
      },
      save: 'Сохранить',
