...
- Счётчик «Документы качества» и выбор существующих документов в материалах используют проектные документы текущего объекта + глобальные.
...
- Глобальный документ нельзя удалить, если он уже используется в актах; API возвращает понятный `409`.
