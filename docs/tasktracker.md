...
- **Статус**: В процессе (D′ + формат п.3 согласованы; ждут Q2/Q3/Q5–Q7)
- **Дата фиксации**: 2026-08-01
- **Описание**: D′ — несколько строк `task_materials` с разными `qualityDocumentId`, партия optional и не ограничивает docs. В п.3 АОСР строки одного материала группируются: «термометр БиТ-63 паспорт зав. №0091, паспорт зав. №0096»; в приложениях — отдельные PDF.
- **Шаги выполнения**:
  ...
  - [ ] Ответы на Q2/Q3/Q5–Q7 (или «бери рекомендации»)
  - [ ] ADR + реализация INST-001…009, в т.ч. `buildP3MaterialsText` groupBy
