...
export const MCP_ERROR_CODES = {
  ...
  SCHEDULE_INPUTS_INCOMPLETE: "SCHEDULE_INPUTS_INCOMPLETE",
  LABOR_DATA_REQUIRED: "LABOR_DATA_REQUIRED",
  SCHEDULE_DRAFT_STALE: "SCHEDULE_DRAFT_STALE",
  SCHEDULE_APPROVAL_CONFLICT: "SCHEDULE_APPROVAL_CONFLICT",
  MATERIAL_REGISTER_NOT_READY: "MATERIAL_REGISTER_NOT_READY",
  MATERIAL_REGISTER_NOT_FOUND: "MATERIAL_REGISTER_NOT_FOUND",
  MATERIAL_REGISTER_STALE: "MATERIAL_REGISTER_STALE",
  DOCUMENT_UPLOAD_INVALID: "DOCUMENT_UPLOAD_INVALID",
  MATERIAL_NOT_OWNED: "MATERIAL_NOT_OWNED",
  DOCUMENT_ALREADY_ATTACHED: "DOCUMENT_ALREADY_ATTACHED",
  ACTS_NOT_READY: "ACTS_NOT_READY",
  ACT_GENERATION_REQUIRES_CONFIRMATION: "ACT_GENERATION_REQUIRES_CONFIRMATION",
